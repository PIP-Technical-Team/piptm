...
_Generated 2026-08-27 · 80 artifacts (newest first) + 29 roadmap features_
...
- **[CRAN readiness \(devtools::check clean\)](roadmap.json#cran-readiness)** · `feature` · _planned_ · `—`
  > CRAN readiness (devtools::check clean)
- **[Data quality contracts and multi-file guard](roadmap.json#data-quality-contracts)** · `feature` · _done_ · `—`
  > Data quality contracts and multi-file guard
...
- **[Dimension pre-filter: exclude partial-match surveys](roadmap.json#dimension-partial-match-exclusion)** · `feature` · _done_ · `—`
  > Dimension pre-filter: exclude partial-match surveys
...
- **[obs_share and pop_share measures](roadmap.json#obs-share-pop-share)** · `feature` · _done_ · `—`
  > obs_share and pop_share measures
- **[Orchestration: batch vs. per-survey optimization](roadmap.json#orchestration-batch-vs-per-survey)** · `feature` · _done_ · `—`
  > Orchestration: batch vs. per-survey optimization
...
- **[Performance benchmarking and profiling](roadmap.json#performance-profiling)** · `feature` · _active_ · `—`
  > Performance benchmarking and profiling
- **[pip_lookup\(\) triplet-to-pip_id resolver](roadmap.json#pip-lookup-triplet-resolver)** · `feature` · _done_ · `—`
  > pip_lookup() triplet-to-pip_id resolver
...
- **[table_maker\(\) with dual input patterns \(pip_id and triplets\)](roadmap.json#table-maker-dual-input)** · `feature` · _done_ · `—`
  > table_maker() with dual input patterns (pip_id and triplets)
